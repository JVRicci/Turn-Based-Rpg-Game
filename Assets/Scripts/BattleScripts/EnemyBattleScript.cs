...
public class EnemyBattleScript : MonoBehaviour
{
    ...
    //     GameObject playerObject = GameBattleControllerScript.instance.playerObject;
    //     Transform playerTransform = playerObject.GetComponent<Transform>();

    //     // Simula o ataque (adiciona um delay antes de voltar)
    //     yield return StartCoroutine(MoveToPosition(enemyTransform, new Vector2(playerTransform.position.x + 2, playerTransform.position.y)));
